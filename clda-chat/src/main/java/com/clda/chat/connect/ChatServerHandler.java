...
import com.clda.chat.core.RingByteBuffer;
import com.clda.chat.core.RawAudioPayload;
import com.clda.chat.core.vad.VoiceActivityDetector;
import com.clda.chat.opus.AudioOpusDecoder;
import com.clda.chat.providers.asr.ASREngine;
import com.clda.chat.providers.tts.BaseTTSProvider;
import com.clda.chat.providers.tts.TTSMessage;
import com.clda.chat.utils.AudioUtils;
import com.clda.chat.utils.TextProcessingUtils;
...
public class ChatServerHandler implements Closeable {
     ...
     */
    public void sendNavigationCommand(String service) {
        String navMessage = new JSONObject()
                .fluentPut("type", "navigate")
                .fluentPut("service", service)
                .fluentPut(ChatConstants.SESSION_ID, sessionId)
                .toJSONString();
        conn.send(navMessage);
        log.info("Sent navigation command: {}", service);
    }
